					...
					<form class="form-horizontal" action="{{url('/admin_dashboard')}}" method="post">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Email">
								...
								<input class="input-large span10" name="admin_email" type="text" placeholder="Email" required />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="admin_password" id="password" type="password" placeholder="Password" required />
							</div>
