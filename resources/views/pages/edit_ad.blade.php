			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/update_ad/'.$product_info->product_id)}}" method="post"
						enctype="multipart/form-data">
							{{csrf_field()}}
						  <fieldset>
				
							<div class="control-group">
							  <label class="control-label" for="date01">Product Name<span class="red-star">*</span></label>
							  <div class="controls">
							...
							>
							  ...
							  <div class="control-group">
								<label class="control-label" for="selectError3">Product Category<span class="red-star">*</span></label>
								<div class="controls">
							  ...
							  <div class="control-group">
								<label class="control-label" for="selectError3">Brand<span class="red-star">*</span></label>
								<div class="controls">
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Product  Description<span class="red-star">*</span></label>
							  <div class="controls">
							...
							<div class="control-group">
							  <label class="control-label" for="date01">Product Price<span class="red-star">*</span></label>
							  <div class="controls">
						...
						<table>
						  <thead>
							  <tr>
							  	  <th>Display Image</th>
								  <th>Optional_Image1</th>
								  <th>Optional_Image2</th>

							  </tr>
						  </thead>  
						  <tbody> 
						  	<tr>
								<td><img src="{{URL::to($product_info->product_image1)}}"style="height:100px; width:100px"alt="templatemo easy profile"></td>

								<td><img src="{{URL::to($product_info->product_image2)}}"style="height:100px; width:100px"alt="templatemo easy profile"></td>

								<td><img src="{{URL::to($product_info->product_image3)}}" style="height:100px; width:100px"alt="templatemo easy profile"></td>
							</tr>
							<tr>
								<td><input class="input-file uniform_on" id="fileInput" type="file" name="product_image1"></td>
								<td><input class="input-file uniform_on" id="fileInput" type="file" name="product_image2"></td>
								<td><input class="input-file uniform_on" id="fileInput" type="file" name="product_image3"></td>
							</tr>
							...
							<div class="control-group">
								<label class="control-label" for="selectError3">Condition<span class="red-star">*</span></label>
								<div class="controls">
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Availability<span class="red-star">*</span></label>
							  <div class="controls">
