...
{{-- 	<ul class="breadcrumb">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content" style="margin-bottom: 100px;">
						<form class="form-horizontal" action="{{url('/save_ad')}}" method="post"
						enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" placeholder="000" class="input-xlarge " name="product_price" required="">
							  </div>
							</div>
