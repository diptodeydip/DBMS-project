					...
					<div class="box-content">
						...
						enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Recommended :</label>
							  <div class="controls">
								<input type="checkbox" name="rec_status" value="1" >
							  </div>
							</div>


							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Availability :</label>
							  <div class="controls">
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Featured :</label>
							  <div class="controls">
