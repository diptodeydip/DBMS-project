...
<body>
    ...
    <div class="container">
      <div class="row"> 
         ...
         <div id="carousel-example-generic" class="carousel slide " data-ride="carousel" style="background-color: #e4e3e2;">
                <!-- Indicators -->
                <ol class="carousel-indicators">
                    @foreach( $all_published_slider as $slide )
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    @foreach( $all_published_slider as $slide )
                        <div class="item {{ $loop->first ? ' active' : '' }}" >
                             <div class="item">
                                <div class="col-sm-5">
                                    <h1><span>S</span>UST</h1>
                                    <h2>Based Online Market</h2>
                                    <p>Anyone From Sust can create an Account here & join the market.........</p>
                                </div>
                                <div class="col-sm-7 pull-right">
                                    <img src="{{ $slide->slider_image }}" class="girl img-responsive" alt="" style="width: 400px; height: 312px;"/>
                                </div>
                            </div>
                        </div>
                    @endforeach
                           ...
                           <div class="panel panel-default">
                                ...
                                <div id="sportswear" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul>
                                            <li><a href="{{URL::to('/product_by_category/12')}}" style="text-transform: none;">Laptops & Computers</a></li>
